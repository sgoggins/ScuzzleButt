...
) ENGINE=InnoDB AUTO_INCREMENT=1484199 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `job` (
  ...
  PRIMARY KEY (`job_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2388 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1051731 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `url` (
  ...
  PRIMARY KEY (`url_id`),
  KEY `analysis_state` (`analysis_state`)
) ENGINE=InnoDB AUTO_INCREMENT=551482 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
